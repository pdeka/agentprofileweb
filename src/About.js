  ...
  render() {
    if (this.state.doc && this.state.aboutpage) {
      ...
      return <div class="sections-page">
        ...
        <div class="page-header header-small" data-parallax="true" style={{backgroundImage: 'url(https://prismic-io.s3.amazonaws.com/rumamundi%2F299afe9b-2b94-4fe8-a7c1-99dbeabee565_ruma-in-group.jpg)'}}>
          <div class="container">
            <div class="row">
