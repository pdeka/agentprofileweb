  ...
  render() {
    if (this.state.doc && this.state.aboutpage && this.state.articles) {
      ...
      return <div class="sections-page">
        ...
        <div class="page-header header-medium header-filter" data-parallax="true" style={{backgroundImage: 'url(https://prismic-io.s3.amazonaws.com/rumamundi%2F3c89da69-a02d-4eb9-b784-1128443aa4c9_temporary-collage.jpg)'}}>
                    ...
                    <div class="card card-plain card-profile mt-5 mb-0">
                          <div class="card-header card-header-image">
                            <div class="embed-responsive embed-responsive-16by9">
                              <iframe title="video ruma mundi stanhope garden sydney" id={'iframe-rounded-corner'} src="https://www.youtube.com/watch?v=C-G183cKqVI" frameBorder="0" gesture="media" allow="encrypted-media" allowFullScreen="true"></iframe>
                            </div>
                          </div>
                          <div class="card-body">
